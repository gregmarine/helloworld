...
module.exports = {
  ...
  gcloud: {
    projectId: 'hwauth-1142'
  },

  // Typically, you will create a bucket with the same name as your project ID.
  cloudStorageBucket: 'hwauth',
  ...
  oauth2: {
    clientId: '88082683467-pluoim65nkeagrcv38310uo1of43digk.apps.googleusercontent.com',
    clientSecret: 'JrDVC9PRsAXfWblU_4fUhY3t',
    redirectUrl: process.env.OAUTH2_CALLBACK ||
      'https://helloworld-gregmarine.c9users.io/oauth2callback',
